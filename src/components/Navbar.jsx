    ...
    items-center p-4">
      ...
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Food <span className="font-bold">Chapchap</span>
        </h1>
      ...
      {/* Mobile menu */}
      {/* Overlay */}
      <div className="bg-black/80 fixed w-full h-screen z-10
      top-0 left-0"></div>
      {/*Side drawer menu*/}
      ...
      z-10 duration-300">
        ...
        <h2 className="text-2xl p-4">Food <span className="font-bold">Chapchap</span></h2>
        <nav>
